...
DEPENDS = "python3-numpy-native python3-pythran-native python3-lazy-loader-native python3-cython-native"

PYPI_PACKAGE = "scikit_image"

inherit pypi python_mesonpy pkgconfig python3native
