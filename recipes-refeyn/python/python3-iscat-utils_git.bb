...
RDEPENDS:${PN} += " \
    python3-asyncio python3-core python3-crypt python3-ctypes \
    python3-datetime python3-html python3-image python3-io \
    python3-json python3-logging python3-misc python3-multiprocessing \
